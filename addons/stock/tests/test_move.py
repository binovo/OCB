...
class StockMove(TransactionCase):
    ...
    def test_move_line_aggregated_product_quantities(self):
        ...
        char_key = "_" if list(aggregate_values.keys())[0][-1] == "_" else ""
        ...
        aggregate_val_1 = aggregate_values[f'{self.product.id}_{self.product.name}__{sml1.product_uom_id.id}{char_key}']
        aggregate_val_2 = aggregate_values[f'{product2.id}_{product2.name}__{sml2.product_uom_id.id}{char_key}']
        aggregate_val_3 = aggregate_values[f'{product4.id}_{product4.name}__{sml3.product_uom_id.id}{char_key}']
        ...
        aggregate_val_1 = aggregate_values[f'{self.product.id}_{self.product.name}__{sml1.product_uom_id.id}{char_key}']
        aggregate_val_2 = aggregate_values[f'{product2.id}_{product2.name}__{sml2.product_uom_id.id}{char_key}']
        aggregate_val_3 = aggregate_values[f'{product3.id}_{product3.name}__{sml3.product_uom_id.id}{char_key}']
        aggregate_val_4 = aggregate_values[f'{product4.id}_{product4.name}__{sml4.product_uom_id.id}{char_key}']
        ...
        aggregate_val_1 = aggregate_values[f'{product3.id}_{product3.name}__{sml1.product_uom_id.id}{char_key}']
        aggregate_val_2 = aggregate_values[f'{product2.id}_{product2.name}__{sm2.product_uom.id}{char_key}']
    ...
    def test_move_line_aggregated_product_quantities_duplicate_stock_move(self):
        ...
        char_key = "_" if list(aggregate_values.keys())[0][-1] == "_" else ""
        aggregated_val = aggregate_values[f'{self.product.id}_{self.product.name}__{self.product.uom_id.id}{char_key}']
    ...
    def test_move_line_aggregated_product_quantities_two_packages(self):
        ...
        char_key = "_" if list(aggregate_values1.keys())[0][-1] == "_" else ""
        aggregated_val = aggregate_values1[f'{self.product.id}_{self.product.name}__{self.product.uom_id.id}{char_key}']
        ...
        char_key = "_" if list(aggregate_values2.keys())[0][-1] == "_" else ""
        aggregated_val = aggregate_values2[f'{self.product.id}_{self.product.name}__{self.product.uom_id.id}{char_key}']
